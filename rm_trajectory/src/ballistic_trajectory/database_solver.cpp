...
namespace rm_trajectory
{
	...
	double DatabaseSolver::get_pitch(double target_distance, double target_h, double bullet_v)
	{
		...
		pitch = f_1 + (f_3 - f_1) / 2 * (target_distance - 1) + ((f_5 - f_3) / 2 - (f_3 - f_1) / 2) / 4 * (target_distance - 1) * (target_distance - 3) + (((f_7 - f_5) / 2 - (f_5 - f_3) / 2) / 4 - ((f_5 - f_3) / 2 - (f_3 - f_1) / 2) / 4) / 6 * (target_distance - 1) * (target_distance - 3) * (target_distance - 5);
